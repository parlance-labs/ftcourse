...
```bash
#download weights
HF_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download --local-dir ./parlance-labs/hc-mistral-alpaca-merged --local-dir-use-symlinks=False parlance-labs/hc-mistral-alpaca-merged
# run server
...
You can also use Cog to make a prediction.
